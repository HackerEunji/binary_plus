...
# Project:  new.pro
# Template: app
# Command: /home/gogo/Qt/5.15.0/gcc_64/bin/qmake -o Makefile new.pro
#############################################################################
...
QMAKE         = /home/gogo/Qt/5.15.0/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/gogo/Qt/5.15.0/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/gogo/Qt/5.15.0/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
...
COMPRESS      = gzip -9f
DISTNAME      = new1.0.0
DISTDIR = /home/gogo/new/.tmp/new1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/home/gogo/Qt/5.15.0/gcc_64/lib
LIBS          = $(SUBLIBS) /home/gogo/Qt/5.15.0/gcc_64/lib/libQt5Gui.so /home/gogo/Qt/5.15.0/gcc_64/lib/libQt5Core.so -lGL -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: new.pro ../Qt/5.15.0/gcc_64/mkspecs/linux-g++/qmake.conf ../Qt/5.15.0/gcc_64/mkspecs/features/spec_pre.prf \
		../Qt/5.15.0/gcc_64/mkspecs/common/unix.conf \
		../Qt/5.15.0/gcc_64/mkspecs/common/linux.conf \
		../Qt/5.15.0/gcc_64/mkspecs/common/sanitize.conf \
		../Qt/5.15.0/gcc_64/mkspecs/common/gcc-base.conf \
